...
(function() {
  var Podcast, activePanel, createPlayer, getAttr, getText, navigateTo, options, panels, podcast, render, renderInside, templates, title2Id, updatePlayer;
  ...
  createPlayer = function(opt) {
    return $(document).ready(function() {
      ...
      return $.get(options.feed, function(data) {
        ...
        return window.addEventListener("hashchange", updatePlayer, false);
      }, "xml");
    });
  };
